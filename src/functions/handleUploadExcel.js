...
export default function handleUploadExcel(e, confirmedDataRows, handleOpenDialog, dataRows, setDataRows) {
    e.preventDefault();
    ...
    reader.onload = (e) => {
        ...
        for (const sheetName of readedData.SheetNames) {
            ...
            if (dataParse.length !== 0) {
                ...
                allSheetData.push(...prepareDataForTable(sheetName, cleanupData, confirmedDataRows));
            }
        }
